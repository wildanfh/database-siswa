...
<section>
  <div class="container mx-auto">
    <h2 class="text-slate-700">Categories</h2>
    <div class="mb-4 mt-3" x-data="{ showSearch: false }">
      ...
      <form x-show="showSearch" id="search-form" action="{{ route('categories.index') }}" method="GET" class="flex h-8">
        <input type="text" name="search" placeholder="Search by category" class="shadow appearance-none border rounded w-3/4 py-2 px-3 text-gray-700 text-sm focus:outline-none focus:shadow-outline">
    ...
    <div class="flex justify-end mb-4">
      <a href="{{ route('categories.create') }}" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded text-sm">
        Create
      </a>
    </div>
